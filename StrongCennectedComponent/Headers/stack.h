...
public:
    ...
    reference top() {if (!empty()) return c.back();} //return the stack top value
    const_reference top() const {if (!empty()) return c.back();} //return the stack top value as const reference
